                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('kontraktor.edit', $row->kontraktor_id) }}"
                                    class="btn btn-outline-success btn-sm" title="Edit Kontraktor">
                                    <i class="fa fa-pen"></i>
                                </a>

                                {{-- Tombol Hapus --}}
                                <form action="{{ route('kontraktor.destroy', $row->kontraktor_id) }}" method="POST"
                                    class="d-inline" onsubmit="return confirm('Yakin ingin menghapus kontraktor ini?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-outline-danger btn-sm" title="Hapus Kontraktor">
